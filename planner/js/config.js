...
const gearLookup = ["UBP_Hat", "UBP_Gloves", "UBP_Shoes", "UBP_Bag", "UBP_Badge", "UBP_Hairpin", "UBP_Charm", "UBP_Watch", "UBP_Necklace",
    ...
    "T2_Hat", "T2_Gloves", "T2_Shoes", "T2_Bag", "T2_Badge", "T2_Hairpin", "T2_Charm", "T2_Watch", "T2_Necklace",
...
var rowColours = {
    ...
    "Shanhaijing": "#b4feca66", "Red Winter": "#d98c9e66", "Valkyrie": "#a1a9e166", "Highlander": "#5A5770", "Wildhunt": "#5A5A46", "Odyssey": "#9ce4fc66", "Nebra": "#99919466", "Phaistos": "#fdf7e766", "Wolfsegg": "#93a5f266",
...
const propertyColours = {
    "Explosion": "#ec242487", "Pierce": "#fff10099", "Piercing": "#fff10099", "Chemical": "#0A6E5F", "Mystic": "#1070a5c2", "Sonic": "#c246d79e",
    ...
    "Arius": "#dbdad85e", "Shanhaijing": "#b4feca66", "RedWinter": "#d98c9e66", "Valkyrie": "#a1a9e166", "Highlander": "#5A5770", "Wildhunt": "#5A5A46", "Odyssey": "#9ce4fc66"
}
...
const inputValidation = {
    ...
    ...Object.fromEntries(
        [
            ...
            name,
            {
                ...
                ...(index > 0
                    ? { Left: `input-${order[index - 1]}` }
                    : { Left: "input-favor_34_3" }),
                ...(index < order.length - 1
                    ? { Right: `input-${order[index + 1]}` }
    ...
    "UBP_Hat": {
        ...
        "max": "99999",
        "navigation": "gearTable",
        "Left": "input-T10_Necklace",
        "Right": "input-UBP_Gloves"
    },
    "UBP_Gloves": {
        "id": "input-UBP_Gloves",
        "location": "gearModal",
    ...
    "UBP_Bag": {
        ...
        "max": "99999",
        "navigation": "gearTable",
        "Left": "input-UBP_Shoes",
        "Right": "input-UBP_Badge"
    },
    "UBP_Badge": {
        "id": "input-UBP_Badge",
        "location": "gearModal",
    ...
    "UBP_Hairpin": {
        ...
        "max": "99999",
        "navigation": "gearTable",
        "Left": "input-UBP_Badge",
        "Right": "input-UBP_Charm"
    },
    "UBP_Charm": {
        "id": "input-UBP_Charm",
        "location": "gearModal",
        ...
        "max": "99999",
        "navigation": "gearTable",
        "Left": "input-UBP_Hairpin",
        "Right": "input-UBP_Watch"
    },
    "UBP_Watch": {
        "id": "input-UBP_Watch",
        "location": "gearModal",
        ...
        "max": "99999",
        "navigation": "gearTable",
        "Left": "input-UBP_Charm",
        "Right": "input-UBP_Necklace"
    },
    "UBP_Necklace": {
